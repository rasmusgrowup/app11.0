    ...
    <>
      ...
      <div className={layout.indexContent}>
        ...
        <p className={typography.indexParagraph}>
          Vi tilbyder <span style={{ color: 'var(--pink)'}} onMouseEnter={() => cursorChangeHandler("camera")} onMouseLeave={() => cursorChangeHandler("")} className='noMouse'>art direction</span>, <span style={{ color: 'var(--red)'}} onMouseEnter={() => cursorChangeHandler("design")} onMouseLeave={() => cursorChangeHandler("")} className='noMouse'>visuelt design</span> og <span style={{ color: 'var(--orange)'}} onMouseEnter={() => cursorChangeHandler("web")} onMouseLeave={() => cursorChangeHandler("")} className='noMouse'>webudvikling</span> — vi kan med andre ord hjælpe jer fra idé til færdig hjemmeside. Med vores <span style={{ color: 'var(--light)'}} onMouseEnter={() => cursorChangeHandler("subscription")} onMouseLeave={() => cursorChangeHandler("")} className='noMouse'>abonnementer</span> kan i desuden let og billigt holde jeres hjemmeside og sociale medier opdateret med nyt indhold — så i ikke går i glemmebogen
        </p>
        <div>
